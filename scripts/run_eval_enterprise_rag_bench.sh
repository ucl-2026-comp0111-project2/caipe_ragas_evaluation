...
# uv run python3 -m ragas_eval.evals --limit-per-category 1 --top-k 5 --agentic --enable-trace-log
uv run python3 -m ragas_eval.evals --limit 1 --top-k 5 --agentic --enable-trace-log